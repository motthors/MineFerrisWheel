...
import mfw._mc.gui.container.ContainerFileManager;
import mfw.message.MFW_PacketHandler;
import mfw.message.MessageFerrisMisc;
import mfw._mc.tileEntity.TileEntityFileManager;
...
//        this.drawTextureBackground(this.guiLeft, this.guiTop, 0, 0, xSize, ySize);
...
//        }
//        
//        drawString(this.fontRendererObj, "Regist :"+String.format("% 4.2f",tile.rotAccel), 210, 5, 0xffffff);
...
//        drawString(this.fontRendererObj, "Size :"+String.format("% 4.2f",tile.Scale), 207, 48, 0xffffff);
...
//       	ERC_ManagerFerrisHweel.CloseRailGUI();
	...
	protected void actionPerformed(GuiButton button)
	{
		...
		MessageFerrisMisc packet = new MessageFerrisMisc(blockposX,blockposY,blockposZ,
				this.GUINameMap.get(button.id).flag , data, 0, tile.reName.getBytes(Charsets.UTF_8));
