...
import mfw._mc._1_7_10.item.SliceMeat.SyabuMeat;
...
//    private IIcon texBottom;
    ...
    /**
     * Gets the block's texture. Args: side, coreSide
     */
    @SideOnly(Side.CLIENT)
    public IIcon getIcon(int side, int meta)
    {
//        return constructSide == 1 ? this.texTop : (constructSide == 0 ? this.texBottom : this.blockIcon);
        return tex;
    }
...
//                            {
//                                world.spawnEntityInWorld(new EntityItem(world, (double)CorePosX + 0.5D, (double)y + 1.5D, (double)z + 0.5D, itemstack1));
//                            }
...
//                        }
//
//                        this.updateByMetadata(world, CorePosX, y, z, nowmeta - 1);
//                    }
//                }
...
//    		world.spawnParticle("cloud", CorePosX+random.nextDouble(), y+0.5, z+random.nextDouble(), 0, 0.1, 0);
    ...
    /**
     * currently only used by BlockCauldron to incrament coreSide-data during rain
     */
...
//    }
    ...
    /**
//     * Gets an item for the block being called on. Args: world, CorePosX, y, z
//     */
//    @SideOnly(Side.CLIENT)
