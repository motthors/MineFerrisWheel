...
import mfw._mc._1_7_10.tileEntity.TileEntityElevatorConstructor;
...
public class blockElevatorConstructor extends BlockContainer{
    ...
    {
        this.TopIcon = iconRegister.registerIcon(MFW_Core.MODID+":elevator_top");
        this.SideIcon = iconRegister.registerIcon(MFW_Core.MODID+":elevator_side");
        this.FrontIcon = iconRegister.registerIcon(MFW_Core.MODID+":elevator_front");
    }
...
//	}
    ...
    public void onBlockPlacedBy(World world, int x, int y, int z, EntityLivingBase player, ItemStack p_149689_6_)
    {
        ...
        TileEntityElevatorConstructor tile = getTileEntityInstance();
    ...
    {
        TileEntityElevatorConstructor tile = (TileEntityElevatorConstructor)world.getTileEntity(x, y, z);
